	...
	[R['Credits']]: [
		{
			...
			note: 'Dark Sectors pay a flat credit bonus on completion: Seimeni (Defense) and Gabii (Survival) carry the chart’s biggest bonus, 20,000 on a 2,400 base for 22,400 per run. Defense rewards rotate every three waves now, so run three waves (or five minutes of Survival), extract and re-queue — staying longer never repeats the bonus. The famous Akkad on Eris nets the same 22,400 from a smaller 18,000 bonus much deeper in the chart, and Pluto’s Sechura/Hieracon top out at 24,400.',
		...
		},
		{
			...
			note: 'Wager 50,000, reach 100 points, collect 250,000 — and every extra round pays another 250,000 with no new stake. Bring a frame that ignores Financial Stress (Rhino or Nezha early, Revenant later) and deposit at exactly 15 points every time: the bulk bonus peaks there (+8 points, +53.3%), smaller banks waste it, and it caps at +10 by 20 so holding longer only adds risk. Only the host needs the node unlocked, so newer players can be taxied in.',
		...
		},
		{
			...
			note: 'A Disruption whose reward table is mostly credit caches: defend all four conduits and rounds 1–4 pay 30k / 30k / 50k / 50k — 160,000 in under twenty minutes, then 50,000 every round for as long as you stay. No wager to front, but Demolishers punish unmodded gear — treat it as the mid-game (roughly MR7–14) step between Dark Sectors and the endgame farms.',
