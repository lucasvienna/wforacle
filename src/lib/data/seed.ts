...
export const seed: Dataset = {
  regions: [
    { id: 'earth', name: 'Earth', kind: 'planet', progressionOrder: 1, factions: ['Grineer'], nodeIds: ['oro'], spoilerGated: false },
    { id: 'venus', name: 'Venus', kind: 'planet', progressionOrder: 2, factions: ['Corpus'], nodeIds: ['fossa'], spoilerGated: false },
    { id: 'mercury', name: 'Mercury', kind: 'planet', progressionOrder: 6, factions: ['Grineer'], nodeIds: [], spoilerGated: false },
    { id: 'mars', name: 'Mars', kind: 'planet', progressionOrder: 3, factions: ['Grineer'], nodeIds: ['war'], spoilerGated: false },
    { id: 'phobos', name: 'Phobos', kind: 'planet', progressionOrder: 4, factions: ['Corpus'], nodeIds: [], spoilerGated: false },
    { id: 'ceres', name: 'Ceres', kind: 'planet', progressionOrder: 5, factions: ['Grineer'], nodeIds: [], spoilerGated: false },
