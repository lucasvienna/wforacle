<script lang="ts">
	...
	import { CREDITS_GUIDE } from '$lib/guides/credits';
...
<!--
	...
	plain-data content from $lib/guides/credits.
-->
...
<GuideLongform resource={data.resource} content={CREDITS_GUIDE} {conceptCards} {workedExample} />
